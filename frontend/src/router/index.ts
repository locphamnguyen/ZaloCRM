...
const routes: RouteRecordRaw[] = [
  ...
  // PHẢI đứng trước param (:id) để Vue Router không match :id='tao-moi'.
  {
    ...
    children: [
      ...
      { path: 'broadcasts/tao-moi',   name: 'Marketing.BroadcastWizard',  component: () => import('@/views/automation/BroadcastWizardView.vue') },
      { path: 'broadcasts/:id',       name: 'Marketing.BroadcastDetail',  component: () => import('@/views/automation/BroadcastDetailView.vue') },
